...
void update_scaling_settings(int width, int height)
{
  ...
  vita_debug_log("update_scaling_settings: width = %u\n", width);
  vita_debug_log("update_scaling_settings: height = %u\n", height);
  vita_debug_log("update_scaling_settings: scaled_width = %f\n", scaled_width);
  vita_debug_log("update_scaling_settings: scaled_height = %f\n", scaled_height);
  vita_debug_log("update_scaling_settings: image_scaling.texture_width = %u\n", image_scaling.texture_width);
  vita_debug_log("update_scaling_settings: image_scaling.texture_height = %u\n", image_scaling.texture_height);
  vita_debug_log("update_scaling_settings: image_scaling.origin_x = %f\n", image_scaling.origin_x);
  vita_debug_log("update_scaling_settings: image_scaling.origin_y = %f\n", image_scaling.origin_y);
  vita_debug_log("update_scaling_settings: image_scaling.region_x1 = %f\n", image_scaling.region_x1);
  vita_debug_log("update_scaling_settings: image_scaling.region_y1 = %f\n", image_scaling.region_y1);
  vita_debug_log("update_scaling_settings: image_scaling.region_x2 = %f\n", image_scaling.region_x2);
  vita_debug_log("update_scaling_settings: image_scaling.region_y2 = %f\n", image_scaling.region_y2);
}
